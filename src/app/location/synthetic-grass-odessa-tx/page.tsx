...
export default function OdessaTX() {
  return (
    <>
      <Header />
      ...
      <section className={styles.hero}>
        <div className="container">
          ...
          >
            <h1>Synthetic Grass Installation in Odessa, TX</h1>
            <p className={styles.subtitle}>
              Premium synthetic grass solutions for Odessa homes and businesses. 
              Beat the drought with beautiful, maintenance-free lawns.
            </p>
        ...
        <div className="container">
          <div className={styles.infoGrid}>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2>Why Odessa Properties Need Synthetic Grass</h2>
              
              <div className={styles.reasonCard}>
                <Droplets className={styles.icon} />
                <h3>Critical Water Shortage</h3>
                <p>
                  Odessa&apos;s water supply faces severe stress from drought 
                  and growing demand. City water rates have increased 40% in 
                  3 years. Synthetic grass uses zero water.
                </p>
              </div>

              <div className={styles.reasonCard}>
                <Building className={styles.icon} />
                <h3>High-Traffic Commercial Areas</h3>
                <p>
                  From the Medical Center to Music City Mall, Odessa&apos;s 
                  commercial properties need durable landscaping that looks 
                  professional without constant maintenance.
                </p>
              </div>

              <div className={styles.reasonCard}>
                <Sun className={styles.icon} />
                <h3>Extreme Heat & Wind</h3>
                <p>
                  With 250+ days of sunshine and frequent dust storms, 
                  maintaining natural grass is a constant battle. Our UV-resistant 
                  turf thrives in Odessa&apos;s harsh climate.
                </p>
              </div>
      ...
      <section className={styles.calculator}>
        <div className="container">
          <h2>Odessa Water Cost Analysis</h2>
          <div className={styles.calculatorContent}>
            <div className={styles.waterRates}>
              <h3>Odessa Water Rate Structure</h3>
        ...
        <div className="container">
          <div className={styles.quoteGrid}>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2>Get Your Free Odessa Quote</h2>
              <p>
                Join the growing number of Odessa property owners saving thousands 
                on water and maintenance. Get your personalized quote with complete 
                ROI breakdown.
              </p>
              <div className={styles.features}>
                <div className={styles.feature}>
                  <CheckCircle className={styles.icon} />
                  <span>Free consultation at your Odessa property</span>
                </div>
                <div className={styles.feature}>
                  <CheckCircle className={styles.icon} />

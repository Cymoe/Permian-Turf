    ...
    <>
      ...
      <section className={styles.hero}>
        <div className="container">
          ...
          >
            <h1>Artificial Turf Installation in Midland, TX</h1>
            <p className={styles.subtitle}>
              Transform your Midland property with water-saving artificial turf. 
              Perfect for the harsh West Texas climate, zero maintenance required.
            </p>
        ...
        <div className="container">
          <div className={styles.infoGrid}>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2>Why Midland Chooses Artificial Turf</h2>
              
              <div className={styles.reasonCard}>
                <TrendingDown className={styles.icon} />
                <h3>Stage 4 Water Restrictions</h3>
                <p>
                  With ongoing drought conditions and water restrictions, 
                  maintaining natural grass in Midland is increasingly difficult 
                  and expensive. Our turf requires zero water.
                </p>
              </div>
        ...
        <div className="container">
          <div className={styles.quoteGrid}>
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2>Get Your Free Midland Quote</h2>
              <p>
                Join hundreds of Midland property owners who&apos;ve already made 
                the switch to water-free landscaping. Get your custom quote with 
                ROI analysis today.
              </p>
